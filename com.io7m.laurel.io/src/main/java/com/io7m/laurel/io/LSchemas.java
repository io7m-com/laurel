...
public final class LSchemas
{
  private static final JXESchemaDefinition SCHEMA_1 =
    JXESchemaDefinition.builder()
      .setFileIdentifier("laurel-1.xsd")
      .setLocation(LSchemas.class.getResource(
        "/com/io7m/laurel/io/laurel-1.xsd"))
      .setNamespace(URI.create("urn:com.io7m.laurel:image-set:1"))
      .build();
