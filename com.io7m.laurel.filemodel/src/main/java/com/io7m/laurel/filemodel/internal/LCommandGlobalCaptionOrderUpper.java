...
public final class LCommandGlobalCaptionOrderUpper
  extends LCommandAbstract<LCaptionID>
{
  ...
  public LCommandGlobalCaptionOrderUpper()
  {
  ...
  public static LCommandFactoryType<LCaptionID> provider()
  {
    return new LCommandFactory<>(
      LCommandGlobalCaptionOrderUpper.class.getCanonicalName(),
      LCommandGlobalCaptionOrderUpper::fromProperties
    );
  }

  private static LCommandGlobalCaptionOrderUpper fromProperties(
    final Properties p)
  {
    final var c = new LCommandGlobalCaptionOrderUpper();
    ...
    final LCaptionID thisID)
  {
    ...
    final var after =
      context.select(
        ...
        .from(GLOBAL_CAPTIONS)
        .where(GLOBAL_CAPTIONS.GLOBAL_CAPTION_ORDER.gt(thisOrder))
    ...
    final var thatId =
      after.get(GLOBAL_CAPTIONS.GLOBAL_CAPTION_ID);
    final var thatOrder =
      after.get(GLOBAL_CAPTIONS.GLOBAL_CAPTION_ORDER);
  ...
  {
    return "Increase global caption order";
  }
}
